# Talk: Your next(js) effect project


## Useful resources

- [Code for the talk](code)
- [Effect Nextjs Vanilla example](https://github.com/mcrovero/effect-nextjs-vanilla-example)
...
- X - [@mcrovero](https://x.com/mcrovero)
